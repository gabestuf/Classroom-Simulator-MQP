...
var spriteList = []
var TableSprite = load("res://Sprites/Table.tscn") # Load the teacher scene
var ChairSprite = load("res://Sprites/Chair.tscn") # Load the chair scene
var RugSprite = load("res://Sprites/Rug.tscn") # Load the rug scene

var StudentSprite = load("res://Sprites/StudentSprite.tscn") # Load the Student scene
var TeacherSprite = load("res://Sprites/TeacherSprite.tscn") # Load the Teacher scene
